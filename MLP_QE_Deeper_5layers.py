...
def assemble_mlp(input_shape, output_shape):
    ...
    hidden = Dropout(0.5)(hidden)
    hidden = Dense(512, activation='relu', name='dense3')(hidden)
    hidden = Dropout(0.5)(hidden)    
    hidden = Dense(512, activation='relu', name='dense4')(hidden)
    hidden = Dropout(0.5)(hidden)
    hidden = Dense(512, activation='relu', name='dense5')(hidden)
    hidden = Dropout(0.5)(hidden)
